 ...
 * orders uses POrder#isSameOrder(Order) for equality so as to ensure that the order being added or updated is
...
public class UniqueOrderList implements Iterable<Order> {
    ...
    public void setPersons(UniqueOrderList replacement) {
     ...
     */
    public void setPersons(List<Order> orders) {
