...
Figure 3.2.1.1 Sequence Diagram for order `find` command
...
Figure 3.3.1.2 Sequence Diagram for `datetime` search
...
Figure 3.6.1.1 Sequence diagram to illustrate `Logic` component interactions for `/assign` command.
